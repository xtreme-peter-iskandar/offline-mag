...
- (void)setUp
{
    ...
    _vertical = NO;
    _shouldRespondToTapGesture = YES;
...
- (void)setShouldRespondToTapGesture:(BOOL)shouldRespondToTapGesture {
    _shouldRespondToTapGesture = shouldRespondToTapGesture;
    [_scrollView removeGestureRecognizer:_tapGesture];
    if (_shouldRespondToTapGesture) {
        [_scrollView addGestureRecognizer:_tapGesture];
    }
}
...
- (void)didTap:(UITapGestureRecognizer *)tapGesture
{
    ...
    if (!_wrapEnabled) {
        ...
        index = _vertical? (point.y / (_itemSize.height)): (point.x / (_itemSize.width));
    }
